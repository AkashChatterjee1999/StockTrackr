package com.stocktrackr.api.v100.provider.messaging;

import com.stocktrackr.api.v100.client.StockPriceResoponse;
...
public class KafkaMessageProducer {
    ...
    public void sendMessage(Topics topic, String key, StockPriceResoponse message) {
