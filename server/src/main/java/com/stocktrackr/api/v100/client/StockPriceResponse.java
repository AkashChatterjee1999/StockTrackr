...
public class StockPriceResponse {
    ...
    public StockPriceResponse(float currentPrice, float previousClosePrice, float highPrice, float lowPrice,
    ...
    public static StockPriceResponse deserialize(String jsonifiedResponse) {
        GsonBuilder builder = new GsonBuilder();
        builder.setPrettyPrinting();
        Gson gson = builder.create();
        return gson.fromJson(jsonifiedResponse, StockPriceResponse.class);
    }
}
